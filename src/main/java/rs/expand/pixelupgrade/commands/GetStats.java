...
public class GetStats implements CommandExecutor
{
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException
    {
        ...
        Boolean canContinue = null, targetAcquired = false;
        Integer slot = null;
        ...
        if (args.<Integer>getOne("slot").isPresent())
        {
            ...
            catch (NumberFormatException e)
            {
                ...
                player.sendMessage(Text.of("\u00A74Usage: \u00A7c/gs (target) <slot>"));
                player.sendMessage(Text.of("\u00A75-----------------------------------------------------"));
            }
        }
        else
                ...
                else if (nbt != null)
                {
                    ...
                    else
                    {
                        ...
                        if (targetAcquired)
                        {
                            ...
                            player.sendMessage(Text.of("\u00A7eIVs: " + ivs1 + "" + ivs2 + "" + ivs3 + "" + ivs4 + "" + ivs5 + "" + ivs6));

                            player.sendMessage(Text.of("\u00A7eTotal EVs: \u00A7a" + totalEVs + "\u00A7e/\u00A7a510\u00A7e (\u00A7a" + percentEVs + "%\u00A7e)"));
                            player.sendMessage(Text.of("\u00A7eEVs: " + evs1 + "" + evs2 + "" + evs3 + "" + evs4 + "" + evs5 + "" + evs6));

                            player.sendMessage(Text.of("\u00A7eGender: \u00A7f" + genderName + "\u00A7f | \u00A7eSize: \u00A7f" + growthName + "\u00A7f | \u00A7eNature: \u00A7f" + natureName + "\u00A7e (\u00A7a" + plusVal + "\u00A7e / \u00A7c" + minusVal + "\u00A7e)"));

                            if (upgradeCount != 0 && isShiny && upgradeCount < 50)
                                player.sendMessage(Text.of("\u00A7eThis shiny Pok\u00E9mon has been upgraded \u00A76" + pokemon.getEntityData().getInteger("upgradeCount") + "\u00A7e times."));
                            else if (upgradeCount != 0 && isShiny)
                                player.sendMessage(Text.of("\u00A7eThis shiny Pok\u00E9mon has been fully upgraded!"));
                            else if (upgradeCount != 0 && isLegendary && upgradeCount < 20)
                                player.sendMessage(Text.of("\u00A7eThis legendary Pok\u00E9mon has been upgraded \u00A76" + pokemon.getEntityData().getInteger("upgradeCount") + "\u00A7e times."));
                            else if (upgradeCount != 0 && isLegendary)
                                player.sendMessage(Text.of("\u00A7eThis legendary Pok\u00E9mon has been fully upgraded!"));
                            else if (upgradeCount != 0 && upgradeCount < 30)
                                player.sendMessage(Text.of("\u00A7eThis Pok\u00E9mon has been upgraded \u00A76" + pokemon.getEntityData().getInteger("upgradeCount") + "\u00A7e times."));
                        ...
                        else
                        {
                            ...
                            if (EVHP < 256 && EVHP > 252 || EVATK < 256 && EVATK > 252 || EVDEF < 256 && EVDEF > 252 || EVSPATK < 256 && EVSPATK > 252 || EVSPDEF < 256 && EVSPDEF > 252 || EVSPD < 256 && EVSPD > 252)
                                player.sendMessage(Text.of("\u00A7cWarning: \u00A76EVs above 252 do nothing. Try using \u00A7c/fixevs\u00A7d."));
                        }
                    }
                }
                else
