	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException
	{
	    ...
	    else
	    {
	        ...
	        else
	        {
	            ...
	            {
	                EntityPixelmon pokemon = (EntityPixelmon)PixelmonEntityList.createEntityFromNBT((NBTTagCompound)nbt, (World)player.getWorld());
	            ...
	            catch (Exception F)
	            {
                    ...
                    System.out.println("\u00A72" + username + "\u00A7a hit an unknown error executing FixEVs. Stack trace follows.");
                    F.printStackTrace();
	            }
	        }
	    }
